      ...
      <div className="space-y-4 sm:space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white flex items-center gap-2 sm:gap-3">
              <Plane className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 text-cyan-400" />
          ...
          >
            {autoMode ? (
              <>
                ...
                <span className="text-xs sm:text-sm">Auto Mode ON</span>
              </>
            ) : (
              <>
                <Pause className="w-4 h-4 mr-1 sm:mr-2" />
                <span className="text-xs sm:text-sm">Manual Control</span>
              </>
            )}
          </Button>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 lg:gap-4">
          <Card className="bg-slate-800/50 border-slate-700">
            <CardContent className="p-3 sm:p-4 lg:p-6 text-center">
              ...
              <p className={`text-sm sm:text-lg lg:text-2xl font-bold ${getPhaseColor(gameState.phase)}`}>
          ...
          <Card className="bg-slate-800/50 border-slate-700">
            <CardContent className="p-3 sm:p-4 lg:p-6 text-center">
              ...
              <p className="text-lg sm:text-xl lg:text-3xl font-bold text-cyan-400">
          ...
          <Card className="bg-slate-800/50 border-slate-700">
            <CardContent className="p-3 sm:p-4 lg:p-6 text-center">
              ...
              <p className="text-sm sm:text-lg lg:text-2xl font-bold text-purple-400">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 lg:gap-6">
          ...
          <Card className="bg-gradient-to-br from-red-900/50 to-red-800/30 border-red-700">
            ...
            <CardContent className="space-y-2 sm:space-y-3">
              ...
              <Button
                ...
                className="w-full bg-red-600 hover:bg-red-700 text-white h-10 sm:h-12 text-sm sm:text-base"
              >
              ...
              <div className="flex gap-1 sm:gap-2 flex-wrap">
                {[1.5, 2.0, 3.0, 5.0, 10.0].map((val) => (
                  <Button
                    ...
                    className="border-orange-600 text-orange-400 hover:bg-orange-600/20 text-xs px-2"
                  >
                    {val}x
                  </Button>
                ))}
          ...
          <Card className="bg-gradient-to-br from-blue-900/50 to-blue-800/30 border-blue-700">
            <CardHeader className="pb-2">
              <CardTitle className="text-white flex items-center gap-2 text-sm sm:text-base lg:text-lg">
                <RotateCcw className="w-4 h-4 sm:w-5 sm:h-5 text-blue-400" />
                Reset Game
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-2 sm:space-y-3">
